...
function DetailPengurus({ idPengurus }) {
  const {
    data: dataPengurus,
    error: errorPengurus,
    ...
    <Layout>
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Detail Pengurus</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card className="border-none shadow-none">
        <CardHeader>
          <CardTitle>Detail Pengurus</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          {isLoadingPengurus ? (
            ...
            <PengurusForm data={dataPengurus.data} disabled={true} />
          )}
        </CardContent>
      </Card>
      <Toaster />
