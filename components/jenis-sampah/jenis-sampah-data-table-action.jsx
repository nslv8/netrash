...
const JenisSampahDataTableAction = ({ idJenisSampah }) => {
  ...
  const confirmDelete = async () => {
    ...
    const res = await deleteForm(`/api/jenisSampah/delete`, tmpData);
    if (res.status != 200) {
      toast({
        variant: "destructive",
        title: "Gagal!",
    ...
    <>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Apakah Anda Ingin MENGHAPUS Data Jenis Sampah ini?
            </AlertDialogTitle>
          </AlertDialogHeader>
...
export default JenisSampahDataTableAction;
